...
const CompanyDetails: React.FC = () => {
  ...
  // Helper component for the "About Us" button logic (for cleaner code)
  const AboutUsButton = ({ isLargeScreen = false }: { isLargeScreen?: boolean }) => (
    ...
    >
      <button
        ...
        type="button"
      >
        <FaArrowRight className={`${isLargeScreen ? 'w-5 h-5' : 'w-4 h-4'} rotate-[-45deg]`} />
      </button>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-y-6 lg:gap-8 items-start">
          ...
          >
            ...
            <div className="flex-grow mt-1">
              ...
              <p className={`text-lg ${FONT_CLASSES.openSansBold} text-gray-800`}>
