      ...
      <section className="py-12 sm:py-16 bg-gray-50 -mt-4 sm:-mt-5">
        <div className="max-w-[1400px] mx-auto px-6 sm:px-8">
          ...
          <div className="mb-10 sm:mb-16">
            {/* Mobile & Mid Screen Layout (with 3 lines) */}
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {[
              ...
              >
                ...
                {/* Description */}
                <p
                  className={`${FONT_CLASSES.rubikRegular} text-gray-700 text-[12px] sm:text-[13px] leading-relaxed font-medium mb-3 sm:mb-4`}
                >
                  {item.desc}
                </p>
