          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-4 leading-relaxed">
                As one of the largest dedicated residential solar companies in
                the industry, we pride ourselves on delivering the best solar
                solutions to our clients. Our commitment to excellence and
                innovation sets us apart in the market.
              </p>
              <p className="text-gray-600 mb-4 leading-relaxed">
                With years of experience and a team of dedicated professionals,
                we have successfully completed numerous projects, helping
                businesses optimize their operations and achieve sustainable
                growth through innovative delivery and transport solutions.
              </p>
              <p className="text-gray-600 mb-6 leading-relaxed">
                At TELEXPH, we believe in powering your business the smart way
                by combining cutting-edge technology with personalized service.
                Our approach ensures that every client receives tailored
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white p-10 rounded-lg shadow-lg border-t-4 border-red-600">
              ...
              <p className="text-gray-600 leading-relaxed">
                To provide innovative and reliable delivery and transport
                solutions that empower businesses to thrive in a competitive
                market. We are committed to excellence, sustainability, and
                customer satisfaction in everything we do. Our goal is to be the
                trusted partner that helps businesses grow and succeed through
            ...
            <div className="bg-white p-10 rounded-lg shadow-lg border-t-4 border-gray-900">
              ...
              <p className="text-gray-600 leading-relaxed">
                To be the leading provider of smart business solutions,
                recognized for our innovation, reliability, and commitment to
                helping businesses achieve their full potential through
                cutting-edge technology and exceptional service. We envision a
                future where every business has access to world-class delivery
